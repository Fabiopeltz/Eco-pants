                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="images p-3">
                                <div class="text-center p-4 product-img"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="product p-4">
                                <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand">eco pants world</span>
                                    <h5 class="text-uppercase product-name">Men's slim fit Pants</h5>
                                    <div class="price d-flex flex-row align-items-center"> 
                                        <span class="act-price product-price">$20</span>
                                    </div>
                                </div>
                                <p class="about product-desc">Shop from a wide range of t-shirt from orianz. Pefect for your everyday use, you could pair it with a stylish pair of jeans or trousers complete the look.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end">
                    <a class="link-dark text-decoration-none me-3" href="about.html">Política de Privacidade</a>
                    <a class="link-dark text-decoration-none" href="about.html">Condições de Uso</a>
                </div>
            </div>
        </div>
    </footer>
